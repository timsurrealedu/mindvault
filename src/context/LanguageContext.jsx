...
const DICT = {
  en: {
    ...
    'dash.quoteSig': 'A gentle reminder for today',
    ...
    'community.replyPlaceholder': 'Write a kind reply…',
    'community.replySent': 'Reply posted to the thread',
    'community.noReplies': 'No replies yet — be the first to offer some support.',
  ...
  id: {
    ...
    'dash.quoteSig': 'Pengingat lembut untuk hari ini',
    ...
    'community.replyPlaceholder': 'Tulis balasan yang baik…',
    'community.replySent': 'Balasan terkirim ke utas',
    'community.noReplies': 'Belum ada balasan — jadilah yang pertama memberi dukungan.',
